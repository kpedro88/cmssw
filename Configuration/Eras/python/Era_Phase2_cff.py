...
Phase2 = cms.ModifierChain(Run3_noMkFit.copyAndExclude([phase1Pixel,trackingPhase1, run3_GEM,seedingDeepCore,displacedRegionalTracking,ctpps_2022,dd4hep]), 
                           phase2_common, phase2_tracker, trackingPhase2PU140, phase2_ecal, phase2_hcal, phase2_hgcal, hcalHardcodeConditions)#, phase2_muon, phase2_GEM)#, phase2_timing, phase2_timing_layer, phase2_trigger)
