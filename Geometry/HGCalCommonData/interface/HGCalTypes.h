...
public:
  ...
  static int32_t layerType(int type, bool print = true);
...
private:
  ...
  static constexpr std::string_view waferType_[nWaferType_] = {"HD120", "LD200", "LD300", "HD200"};
  static constexpr int32_t nWaferTypeX_ = 27;
  static constexpr std::string_view waferTypeX_[nWaferTypeX_] = {
