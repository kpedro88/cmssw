...
protected:
  ...
  virtual void output(edm::Event & iEvent, edm::EventSetup const& iSetup, const std::vector<fastjet::PseudoJet>& fjJets, const std::string& name, const std::string& collName, bool writeCompound);

  template< typename T >
  void writeJets( edm::Event & iEvent, edm::EventSetup const& iSetup, const std::vector<fastjet::PseudoJet>& fjJets, const std::string& name, const std::string& collName  );
  
  template< typename T>
  void writeCompoundJets(  edm::Event & iEvent, edm::EventSetup const& iSetup, const std::vector<fastjet::PseudoJet>& fjJets, const std::string& name, const std::string& collName );

  template< typename T>
    void writeJetsWithConstituents(  edm::Event & iEvent, edm::EventSetup const& iSetup, const std::vector<fastjet::PseudoJet>& fjJets, const std::string& name, const std::string& collName );
