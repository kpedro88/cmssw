...
phase2_GE0.toModify( theMixObjects,
    mixSH = dict(
        input = list(filter(lambda x: type(x) == type(cms.InputTag("","")) and x != cms.InputTag("g4SimHits","MuonME0Hits") and x != cms.InputTag("g4SimHits","MuonGEMHits"), theMixObjects.mixSH.input)), #type(x) == type(cms.vstring("")) and 
